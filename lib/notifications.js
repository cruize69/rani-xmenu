          ...
          <tr>
            <td style="background-color:#0d0c0a;padding:32px 20px 22px;text-align:center;border-bottom:2px solid #E8A82E;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td align="center">
                    <img src="https://ranimahal.food/logo/apsara-square.png" alt="Rani Mahal Logo" width="64" height="64" style="display:block;margin:0 auto 10px;border:0;outline:none;border-radius:50%;box-shadow:0 0 18px rgba(232,168,46,0.45);" />
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#1a1612;border:1px solid rgba(232,168,46,0.25);border-radius:14px;margin-bottom:24px;">
                <tr>
                  <td style="padding:18px;">
                    ...
                    ${isDelivery ? `
                      <p style="font-family:'Fraunces',Georgia,serif;font-size:16px;color:#FAF6EF;margin:0 0 4px;font-weight:500;line-height:1.3;">
                        ${addr.street || "Delivery Order"}${addr.apt ? `, ${addr.apt}` : ""}
                      </p>
                      <p style="font-family:'Inter',sans-serif;font-size:13px;color:#B8A995;margin:0 0 16px;line-height:1.5;">
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td style="padding-bottom:10px;">
                          <a href="https://maps.google.com/?q=${mapQuery}" target="_blank" style="display:block;width:100%;padding:12px 0;background-color:#E8A82E;color:#080706;border-radius:24px;font-family:'Inter',sans-serif;font-size:13px;font-weight:700;text-decoration:none;text-align:center;box-sizing:border-box;">
                      ...
                      <tr>
                        <td>
                          <a href="tel:9148359066" style="display:block;width:100%;padding:11px 0;background-color:transparent;color:#FAF6EF;border:1px solid rgba(250,246,239,0.3);border-radius:24px;font-family:'Inter',sans-serif;font-size:13px;font-weight:600;text-decoration:none;text-align:center;box-sizing:border-box;">
                            Call (914) 835-9066
                          </a>
                        </td>
                      </tr>
