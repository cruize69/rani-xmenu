          ...
          <tr>
            <td style="background-color:#080706;padding:32px 24px 24px;text-align:center;border-bottom:1.5px solid #E8A82E;">
              <div style="margin-bottom:12px;">
                <img src="https://ranimahal.cc/logo/apsara-square.png" alt="Rani Mahal Logo" width="68" height="68" style="display:block;margin:0 auto;border:0;outline:none;text-decoration:none;border-radius:50%;box-shadow:0 0 16px rgba(232,168,46,0.35);" />
              </div>
          ...
          <tr>
            <td style="background-color:#080706;padding:24px;text-align:center;border-top:1px solid rgba(250,246,239,0.08);">
              ...
              <p style="font-family:'Inter',sans-serif;font-size:12px;color:#B8A995;margin:0 0 14px;line-height:1.8;">
                <a href="https://ranimahal.cc" target="_blank" style="color:#E8A82E;text-decoration:none;font-weight:500;">Online Menu</a> &nbsp;·&nbsp;
...
export async function sendOrderEmail(order) {
  ...
  const recipients = (RESTAURANT_EMAIL ?? "orders@ranimahal.cc").split(",").map(s => s.trim()).filter(Boolean);
