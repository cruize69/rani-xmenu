...
function orderEmailShell({ eyebrow, heading, bodyBefore = "", bodyAfter = "", order }) {
  ...
  const step2Color = isDone ? "#E8A82E" : "#342820";
  const line1Color = isDone ? "#E8A82E" : "#342820";
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:16px;margin-bottom:4px;">
                <tr>
                  <td align="center" style="vertical-align:middle;width:24px;">
                    <div style="width:14px;height:14px;border-radius:50%;background-color:${step1Color};box-shadow:0 0 8px ${step1Color};margin:0 auto;"></div>
                  </td>
                  <td style="vertical-align:middle;padding:0 8px;">
                    <div style="height:3px;background-color:${line1Color};border-radius:2px;"></div>
                  </td>
                  <td align="center" style="vertical-align:middle;width:24px;">
                    <div style="width:14px;height:14px;border-radius:50%;background-color:${step2Color};${isDone ? "box-shadow:0 0 8px #E8A82E;" : ""}margin:0 auto;"></div>
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding-top:6px;"><span style="font-size:10px;font-weight:700;letter-spacing:0.04em;text-transform:uppercase;color:#E8A82E;">Received</span></td>
                  <td></td>
                  <td align="center" style="padding-top:6px;"><span style="font-size:10px;font-weight:700;letter-spacing:0.04em;text-transform:uppercase;color:${isDone ? "#E8A82E" : "#B8A995"};">${step2Label}</span></td>
                </tr>
              </table>
            </td>
          </tr>
