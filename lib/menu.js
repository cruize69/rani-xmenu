...
export const CATERING_ITEMS = [
  { id:"catering-essentials",       name:"Essentials Catering (per person)",                  price:19.99, desc:"Samosa/pakora, 2 mains + Palak Paneer, dal, rice, garlic naan, raita. Minimum 16 guests.",                    badge:null, spiceProfile:"none", veg:false },
  ...
  { id:"catering-feast",            name:"Rani Feast Catering — no lamb (per person)",        price:44.95, desc:"Tandoori starter, 4 mains incl. seafood, biryani, dal, 3 naans, raita, chutney, salad. Minimum 25 guests.",   badge:null, spiceProfile:"none", veg:false },
  { id:"catering-feast-lamb",       name:"Rani Feast Catering — with lamb (per person)",      price:49.95, desc:"Same as Rani Feast, includes Lamb Rogan Josh. Minimum 25 guests.",                                            badge:null, spiceProfile:"none", veg:false },
];

// { catering-item-id: minimum guest count } — enforced client-side in
// Catering.jsx before the "Add to Cart" button is even clickable. Essentials'
// minimum is 16, not the package's originally-stated 15 — 15 x $19.99 =
// $299.85, three cents under the $300 order minimum; 16 clears it cleanly.
export const CATERING_MINIMUMS = {
  "catering-essentials": 16,
  "catering-signature": 20,
  "catering-signature-seafood": 20,
  "catering-signature-lamb": 20,
  "catering-feast": 25,
  "catering-feast-lamb": 25,
};
