...
export const CATERING_ITEMS = [
  { id:"catering-essentials",       name:"Essentials Catering (per person)",                  price:19.99, desc:"Samosa/pakora, 2 mains + Palak Paneer, dal, rice, garlic naan, raita. Minimum 15 guests.",                    badge:null, spiceProfile:"none", veg:false },
...
// site's order minimum (ORDER_MINIMUM in Catering.jsx) is derived FROM
// these numbers, not the other way around — Essentials' natural minimum
// of 15 guests IS the floor, not a number bumped up to clear some other
// arbitrary minimum.
