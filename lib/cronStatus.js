...
export const CRON_JOBS = [
  ...
  "cultural-calendar",
  "blog-draft-check",
  // Previously missing from this list despite the cron existing and
  // running fine — meant it had zero dashboard visibility (no "last run",
  // couldn't be triggered manually via Run Now). Found during this
  // session's infrastructure review.
