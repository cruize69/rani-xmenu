...
const RECEIPT_WIDTH = 42; // Standard 80mm thermal paper width
 ...
 * Formatted to 36-column width for 9.5pt Bold Courier New edge-to-edge printing
 */
export function buildPlainTextReceipt(order) {
  ...
  const W = 36; // 36 chars fits 9.5pt Bold Courier New edge-to-edge on 80mm paper!
  ...
  lines.push("====================================");
  lines.push(isDelivery ? "BADGE:***  DELIVERY ORDER  ***" : "BADGE:***   PICKUP ORDER   ***");
  lines.push("====================================");
