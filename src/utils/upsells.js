...
export const S = {
  ...
  DRINK:      new Set(["item-mango-lassi","item-sweet-lassi","item-nemkin-lassi","item-nimbu-pani","item-root-beer","item-san-pellegrino","item-poland-spring","item-tea-coffee","item-ice-tea","item-coke","item-diet-coke","item-sprite","item-ginger-ale","item-club-soda","item-tonic","item-cranberry-juice","item-apple-juice","item-orange-juice","item-pineapple-juice","item-mango-juice"]),
  ...
  VEG:        new Set(["item-aloo-gobi","item-baingan","item-chana-masala","item-palak-paneer","item-malai-kofta","item-shahi-paneer","item-navaratan","item-chana-sag","item-dal-maharani","item-dal-tarka","item-veg-biriyani","item-paneer-tikka","item-sabji-lajawaab","item-broccoli-jalfreazy","item-sabji-masala","item-bhindi-mafaz","item-aloo-gobi-palak","item-rani-ki-avial","item-mushroom-masala","item-mutter-paneer"]),
  ...
  SIDE:       new Set(["item-mango-chutney","item-mixed-pickles","item-raita","item-rice","item-masala-sauce","item-hot-sauce"]),
